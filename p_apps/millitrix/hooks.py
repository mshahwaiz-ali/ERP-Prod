...
doc_events = {
	...
	"Purchase Invoice": {
		...
		"on_cancel": "# DISABLED millitrix.trading.purchase_invoice.on_cancel",
	},
	"Purchase Return": {
		"validate": [_erpnext_compat, "millitrix.trading.purchase_return.validate"],
		"on_submit": "millitrix.trading.purchase_return.on_submit",
		"on_cancel": "# DISABLED millitrix.trading.purchase_return.on_cancel",
	},
	"Purchase Other Bill": {
		...
		"on_cancel": "# DISABLED millitrix.trading.purchase_other_bill.on_cancel",
	},
	"Sales Order": {
		"validate": [_erpnext_compat, "millitrix.trading.sales_order.validate"],
		"on_submit": "millitrix.trading.sales_order.on_submit",
		"on_cancel": "# DISABLED millitrix.trading.sales_order.on_cancel",
	},
	"SO Cancellation": {
	...
	"Sales Other Bill": {
		...
		"on_cancel": "# DISABLED millitrix.trading.sales_other_bill.on_cancel",
	},
	"Voucher Transaction": {
	...
	"PaySlip": {
		...
		"on_cancel": "# DISABLED millitrix.hr.employee_payslip.on_cancel",
	},
	"Advance Adjustment": {
	...
	"Purchase Return Other Bill": {
		...
		"on_cancel": "# DISABLED millitrix.trading.purchase_other_bill_return.on_cancel",
	},
	"Sales Return Other Bill": {
		...
		"on_cancel": "# DISABLED millitrix.trading.sales_other_bill_return.on_cancel",
	},
	"Pay Salary Increment": {
		...
		"on_cancel": "# DISABLED millitrix.hr.pay_salary_increment.on_cancel",
	},
	"Party": {},
	"Item Setup": {},
	"Chart of Accounting": {},
...
has_permission = {
	dt: "millitrix.utils.user_permissions.has_permission"
...
for _setup_dt in ("Module", "Menu", "Document Type"):
	pass  # intentionally empty (admin-only system)
