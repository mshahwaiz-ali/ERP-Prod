...
# Oracle AdvPAdjustReg.rep — Payable Advance Adjustment register.
...
def execute(filters=None):
	...
	return advance_adjustment_register_columns(payment=True), get_advance_adjustment_register(
		filters, received=False
	)
