...
# Oracle SupplierLedgerSummary.RDF

from __future__ import annotations

from frappe import _

from millitrix.utils.extended_reports import get_supplier_ledger_summary_rows
from millitrix.utils.report_filters import normalize_report_dates


def execute(filters=None):
	return get_columns(), get_supplier_ledger_summary_rows(normalize_report_dates(filters))
