...
# Oracle BankLedger.RDF — single bank account ledger

from __future__ import annotations

from millitrix.utils.finance_reports import get_bank_ledger_rows
...
def execute(filters=None):
	...
	return columns, get_bank_ledger_rows(filters)
